...
public final class ActivityThemeBinding implements ViewBinding {
  ...
  private ActivityThemeBinding(@NonNull ConstraintLayout rootView, @NonNull Switch switchDark,
      @NonNull TextView textDark) {
  ...
  public static ActivityThemeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.switch_dark;
      Switch switchDark = ViewBindings.findChildViewById(rootView, id);
      if (switchDark == null) {
        break missingId;
      }

      id = R.id.text_dark;
      TextView textDark = ViewBindings.findChildViewById(rootView, id);
      if (textDark == null) {
        break missingId;
      }

      return new ActivityThemeBinding((ConstraintLayout) rootView, switchDark, textDark);
    }
