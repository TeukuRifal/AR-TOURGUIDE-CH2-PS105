...
public final class ItemRowObjekBinding implements ViewBinding {
  @NonNull
  ...
  private ItemRowObjekBinding(@NonNull CardView rootView, @NonNull CardView cardView,
      @NonNull CircleImageView imgItemPhoto, @NonNull TextView tvItemDescription,
  ...
  @NonNull
  public static ItemRowObjekBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRowObjekBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_row_objek, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRowObjekBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRowObjekBinding((CardView) rootView, cardView, imgItemPhoto, tvItemDescription,
          tvItemName);
    }
